...
interface BufferedEvent extends AnalyticsEventInput {
  timestamp: Date;
}
 ...
 */
export async function countEventsByType(range: DateRange) {
 ...
 */
export async function dailyEventCounts(eventType: AnalyticsEventType, range: DateRange) {
 ...
 */
export async function getProviderPerformance(providerId: string, range: DateRange) {
 ...
 */
export async function getPlatformMetrics(range: DateRange) {
  const [
    totalUsers,
    newUsers,
    totalJobs,
 ...
 */
export async function getUserActivity(userId: string, range: DateRange) {
  return prisma.analyticsEvent.groupBy({
    by: ['eventType'],
    _count: { id: true },
    where: {
