...
export async function verifyResendFromDomain(domain = RESEND_FROM_EMAIL.split('@')[1] || '') {
...
export async function sendEmailVerificationEmail(to, name, code, token) {
...
export async function sendJobPostedEmail(to, data) {
    return sendEmail({
        to,
...
export async function sendProviderSelectedEmail(to, data) {
    return sendEmail({
        to,
...
export async function sendBidReceivedEmail(to, data) {
    return sendEmail({
        to,
...
export async function sendModificationRequestEmail(to, data) {
    return sendEmail({
        to,
...
export async function sendPaymentSuccessEmail(to, data) {
    return sendEmail({
        to,
...
export async function sendEscrowReleasedEmail(to, data) {
    return sendEmail({
        to,
...
export async function sendDisputeUpdateEmail(to, data) {
    const statusColors = {
        OPEN: '#f59e0b',
        UNDER_REVIEW: '#3b82f6',
        RESOLVED: '#4ade80',
...
export async function sendRatingReminderEmail(to, data) {
    return sendEmail({
        to,
