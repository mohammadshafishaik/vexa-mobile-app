...
router.get('/bidding/active-jobs', async (_req, res) => {
    try {
...
router.get('/bidding/jobs/:jobId', async (req, res) => {
    try {
...
router.get('/bidding/anomalies', async (req, res) => {
    try {
        ...
        if (anomalyType)
            where.anomalyType = String(anomalyType);
        if (jobId)
...
router.post('/bidding/anomalies', async (req, res) => {
    try {
        const { jobId, bidId, providerId, anomalyType, severityScore, reason, metadata, } = req.body;
...
router.post('/bidding/anomalies/scan', async (_req, res) => {
    try {
...
router.patch('/bidding/anomalies/:id/status', async (req, res) => {
    try {
