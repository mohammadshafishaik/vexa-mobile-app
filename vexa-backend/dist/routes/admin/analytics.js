...
router.get('/analytics/overview', async (_req, res) => {
    try {
        const [totalUsers, totalCustomers, totalProviders, totalAdmins, suspendedUsers, bannedUsers, totalJobs, activeJobs, paidJobs, totalDisputes, openDisputes, totalPayments, paymentCompletedAggregate, paymentRefundedAggregate, totalKycDocs, pendingKycDocs, openAnomalies, totalChatMessages, totalProviderSkills, totalPortfolioItems, totalCancellations, onlineProviders,] = await Promise.all([
            prisma.user.count(),
